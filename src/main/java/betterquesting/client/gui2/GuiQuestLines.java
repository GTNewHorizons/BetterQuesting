...
public class GuiQuestLines extends GuiScreenCanvas implements IPEventListener, INeedsRefresh {
                    ...
                    if (questExistsUnderMouse) {
                        int maxWidth = questExistsUnderMouse
                                ? RenderUtils.getStringWidth(
                                        QuestTranslation.translate("betterquesting.btn.share_quest"), fr)
                                : 0;
                        ...
                        Runnable questSharer = () -> {
                            mc.thePlayer.sendChatMessage("betterquesting.msg.sharequest:"
                                    + cvQuest.getButtonAt(mx, my)
                                            .getStoredValue()
                                            .getID());
                            mc.displayGuiScreen(null);
                        };
                        popup.addButton(
                                QuestTranslation.translate("betterquesting.btn.share_quest"), null, questSharer);
                        openPopup(popup);
                        return true;
                    }
                }
    ...
    private void refreshQuestCompletion() {
        ...
        completionText.setText(
                QuestTranslation.translate("betterquesting.title.completion", questsCompleted, totalQuests));
    }
